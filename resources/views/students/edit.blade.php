        ...
        <form action="{{ route('edit', $student->id) }}" method="POST">
            ...
            <div class="form">
                <div class="bg-secondary rounded h-100 p-4">
                    <h6 class="mb-4">Student Application Form </h6>
                    ...
                    <div class="form-floating mb-3">
                        ...
                        <label for="floatingInput">{{ $student->address }}</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" value="{{ $student->mobile }}" name="mobile"
                            id="floatingPassword" placeholder="Mobile">
                        <label for="floatingPassword">{{ $student->mobile }}</label>
                    </div>
