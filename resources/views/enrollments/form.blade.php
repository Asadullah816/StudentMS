...
<div class="content">
    ...
    <div class="container mt-5">
        <form action="{{ route('enrollForm') }}" method="POST">
            @if ($errors->any())
            ...
            <div class="form">
                <div class="bg-secondary rounded h-100 p-4">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" name="enroll_no" id="floatingInput"
                            placeholder="name@example.com">
                        <label for="floatingInput">Enrollment Number</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="date" class="form-control" name="join_date" id="floatingInput"
                            placeholder="name@example.com">
                    ...
                    <div class="form-floating mb-3">
                        <input type="number" class="form-control" name="fee" id="floatingInput"
                            placeholder="name@example.com">
