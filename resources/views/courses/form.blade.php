...
<div class="content">
    ...
    <form action="{{ route('courseForm') }}" method="POST">
        @if ($errors->any())
        ...
        <div class="form">
            <div class="bg-secondary rounded h-100 p-4">
                ...
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" name="syllabus" id="floatingInput"
                        placeholder="name@example.com">
                    <label for="floatingInput">Syllabus</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" name="duration" id="floatingPassword"
                        placeholder="Mobile">
