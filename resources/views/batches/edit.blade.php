...
<div class="content">
    ...
    <div class="container mt-5">
        <form action="{{ route('batchEdit', $batch->id) }}" method="POST">
            @if ($errors->any())
            ...
            <div class="form">
                <div class="bg-secondary rounded h-100 p-4">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" value="{{ $batch->name }}" name="name"
                    ...
                    <select name="course_id" class="form-select form-select-lg mb-3"
                        ...
                        <option selected value="{{ $batch->course_id }}">{{ $batch->course->name }}</option>
